...
export const comp17 = {
    "lioto": [
        ...
        },
        {
            ...
            "alternatives": [
                ...
                {
                    "option": "Conduta expectante com corticoide tópico.",
                    "isTrue": false
                },
                {
                    "option": "Receitar vasoconstritor. ",
                    "isTrue": false
                },
                {
                    "option": "Encaminhamento para serviço especializado com avaliação para adenoidectomia. ",
                    "isTrue": false
                }
            ]
        },
        {
            ...
            "alternatives": [
                {
                    "option": "Desvio de septo.",
                    "isTrue": true
                },
                {
                    "option": "Corpo estranho em nariz. ",
                    "isTrue": false
                },
                {
                    "option": "Pólipo nasal.",
        ...
        },
        {
            ...
            "alternatives": [
                {
                    "option": "Rinite alérgica: obstrução unilateral. Desvio  septado: padrão bilateral. ",
                    "isTrue": false
                },
                {
                    "option": "Rinite alérgica: padrão intermitente. Desvio de septo: padrão contínuo.",
                    "isTrue": true
                },
                {
                    "option": "Rinite alérgica: padrão persistente . Desvio de septo: padrão flutuante.",
                    "isTrue": false
                },
                {
                    "option": "Rinite alérgica: padrão bilateral. Desvio de septo: padrão flutuante.",
                    "isTrue": false
                }
            ]
        },
        {
            ...
            "alternatives": [
                ...
                {
                    "option": "Obstrução nasal unilateral ",
                    "isTrue": true
                },
                {
                    "option": "Fotofobia",
        ...
        },
        {
            ...
            "alternatives": [
                {
                    "option": "O desvio de septo nasal é a causa mais provável dos sintomas do paciente.",
                    "isTrue": false
                },
                {
                ...
                {
                    "option": "O desvio de septo nasal é uma condição benigna que não requer tratamento.",
                    "isTrue": false
                },
                {
                    "option": "O desvio de septo nasal deve ser corrigido cirurgicamente para aliviar os sintomas.",
                    "isTrue": false
                }
            ]
        },
    ...
    "devolutiva": "Espera-se que você tenha conhecimento sobre os sinais e sintomas comuns nos desvios de septo nasal obstrutivo. Reconhecendo as situações  que devem ser  encaminhadas para avaliação e tratamento especializado.",
    "description": "Ter conhecimento sobre a clínica, os sinais e os sintomas do desvio de septo nasal obstrutivo. Encaminhar para avaliação especializada os pacientes com anamnese e exame físico compatíveis para diagnóstico e conduta"
}